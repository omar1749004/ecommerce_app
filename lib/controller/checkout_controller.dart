...
class CheckoutControllerImp extends CheckoutController {
  ...
  getShippingAddress() async {
    ...
    if (await checkinternet()) {
      var res = await AddressData()
          .getadress(myServices.sharedPreferences.getString("id")!);
      ...
      if (paymentMethod != "0") {
        paymentBotoomSheet(() async {
          if (paymentIndex == null) {
            ...
            statusRequs = StatusRequst.loading;
            String paymentKey =
                await PaymobManger().getPaymentkeyFristThreeStep(10, "EGP");
            if (paymentKey == "error") {
              statusRequs = StatusRequst.failure;
            } else {
              if (paymentIndex == 0) {
                ...
                String url =
                    await PaymobManger().mobileWallets(authToken: paymentKey);
  ...
  paypalCheckout() {
    PaypalCheckout(
      sandboxMode: true,
      clientId:
          "ATTKK3s-dFeKdTAzNuTJa_aoYr7FD0IK_ir7IN5isyt94e8muqAwdfWeGExbrEilNTUbGlskv4CHg6WQ",
      secretKey:
          "EOVdYoT2cd-EuXimOgHaYoJKMWkHxTLHKLj8pGAEKO0UgtT3_CMMtWRlDD3J1DBPGDyAWkRxicxldpXu",
