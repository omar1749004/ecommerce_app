...
class CustomLitItem extends GetView<OffersController> {
  const CustomLitItem({super.key, required this.itemModel});
                  ...
                  children: [
                    Hero(
                      ...
                      child: CachedNetworkImage(
                          height: 130,
                          imageUrl:
                              "${linkImageUpload}/${itemModel.itemImage}"),
                    ),
                    Text(
                        translateDataBase(
                          ...
                          builder: (controller) => IconButton(
                            onPressed: () {
                              if (controller.isFavorite[itemModel.itemId] ==0
                                ...
                                controller
                                    .addFavorite(itemModel.itemId.toString());
